...
- Author the remaining `docs/monsters.md` roster. Two tiers are done — undead (**Lich**, **Grave Hulk**, gated on `necromancy`) and demons (**Balor**, **Infernal Hound**). Still to author: Stone Warden, Gnoll, Kobold, Cultist, Hexbinder, Ogre, Ironbound, Shadow Stalker, Assassin Wisp, Beastling, Flesh Amalgam, Void-Touched, Overseer, Archivist.
