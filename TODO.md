...
- Author the remaining `docs/monsters.md` roster. The undead tier is done — **Lich** and **Grave Hulk** have sprites, `monsters.json` entries and a `necromancy` unlock. Still to author: Stone Warden, Gnoll, Kobold, Cultist, Hexbinder, Ogre, Ironbound, Shadow Stalker, Assassin Wisp, Balor, Infernal Hound, Beastling, Flesh Amalgam, Void-Touched, Overseer, Archivist.
