...
- **The sprite renderer shades large ellipsoids almost black.** The shipped zombie is close to a silhouette at 64px for this reason, and the Grave Hulk has the same problem — spheres and thin cylinders light properly, large bodies do not. Anyone doing the animation or lighting pass should look at the Blinn-Phong normals in `graphics_gen/core/material.rs` before drawing more big creatures.
